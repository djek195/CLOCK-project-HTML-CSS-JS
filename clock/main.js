...
function clock() {
   ...
   // (360 / 12) / (60 * 60)
    ...
    digitalSecond.innerHTML = showTwoDigitNum(date.getSeconds());
    digitalMinute.innerHTML = showTwoDigitNum(date.getMinutes());
    digitalHour.innerHTML = showTwoDigitNum(date.getHours());
}
